...
* Install ruby 1.9, rubygems and bundler on your Ubuntu 12.04 machine and set a symlink
  
 sudo apt-get install ruby1.9 rubygems bundler
...
* Install socketstream version 0.2 and dependencies using npm
 ...
 sudo npm install socketstream@0.2 -g hiredis redis
...
* checkout an example app (TBD) and let bundle install all gem dependencies (this will take a while if you have not disabled doc generation - see above)

* start the example app (this will start a new tabbed console terminal 

 TBD...

* wait some seconds then use the latest google chrome or chromium browser to access the platform:
