...
* checkout statemachine, scxml, em-hiredis, dm-redis-adapter, MINT-core, MINT-nodejs, MINT-debugger
 ...
 git clone ssh://git@multi-access.de/MINT-nodejs
 git clone ssh://git@multi-access.de/MINT-debugger
...
* log in with user "testuser" and you shold see the server-sided mouse pointer synchronization by a green dot following
  the mouse pointer
